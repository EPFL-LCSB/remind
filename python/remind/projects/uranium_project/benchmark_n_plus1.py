...
comm_name = 'Geobacter_Rhodoferax_Shewanella'
model = load_json_model('../community_models/{}_community.json'.format(comm_name))
...
# if obj_num == 4:
#     model.objective = yield_expr_geo + yield_expr_rhod + yield_expr_shew + cooperations
...
sols,_ = find_alternative_solutions(model, growth_ids, growth_limits, 
                                alternation = alternation, max_alts=100, criteria=1)
